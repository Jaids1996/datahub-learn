...
You can now move ahead to the instructions of the first tutorial step by clicking on the "Next: Connect to Tezos" button below on the right.

You may also continue reading for a brief introduction to Tezos before continuing with the Pathway, if you would like to know more.
